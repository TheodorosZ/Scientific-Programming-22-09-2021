...
# =============================================================================
##### !!IMPORTANT!! EDIT HERE:
   1. At step 0.2.1, on line 78, between the quotion marks within "sys.path.append(r')",
   ...
   2. At step 0.2.2, on line 88, between the quotion marks within "os.chdir(r'')" 
       set directory to the FOLDER where the datafile(s) are stored
   3. At step 0.2.3, on line 97, between the quotation marks in 
   ...
   4. At step 0.2.4, on line 104, after 
       yValidation = 
...
# # This distribution doesn't show a large imbalance, so a random train-test split 
...
cv_outer =  StratifiedKFold(n_splits=5, shuffle=False, random_state=23) # returns 5 stratified folds
cv_inner = StratifiedKFold(n_splits=4, shuffle=False, random_state=23) # returns 4 stratified folds
...
# =============================================================================
"""
Note: this step is redundant when the labels for the otherwise unlabeled validation data are available 
"""
...
finalResults = final_predictionClf(final_clf = finalCLF, 
                                   ...
                                   Kfeat = 200)
# report the performance in terms of classification accuracy. 
